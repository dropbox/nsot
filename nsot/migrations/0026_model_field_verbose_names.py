    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.BooleanField(
                default=False,
                help_text="Whether the Attribute should be be displayed by default in UIs. If required is set, this is also set.",
            ),
        ),
        migrations.AlterField(
            model_name="attribute",
        ...
        migrations.AlterField(
            ...
            name="name",
            field=models.CharField(
                help_text="The name of the Attribute.", max_length=64, db_index=True
            ),
        ),
        migrations.AlterField(
            model_name="attribute",
            name="required",
            field=models.BooleanField(
                default=False, help_text="Whether the Attribute should be required."
            ),
        ),
        migrations.AlterField(
            model_name="attribute",
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(
                help_text="The timestamp of this Change.", auto_now_add=True
            ),
        ),
        migrations.AlterField(
            model_name="change",
        ...
        migrations.AlterField(
            ...
            field=django_extensions.db.fields.json.JSONField(
                help_text="Local cache of attributes. (Internal use only)", blank=True
            ),
        ),
        migrations.AlterField(
            model_name="device",
            name="hostname",
            field=models.CharField(
                help_text="The hostname of the Device.", max_length=255, db_index=True
            ),
        ),
        migrations.AlterField(
            model_name="device",
        ...
        migrations.AlterField(
            ...
            field=nsot.fields.BinaryIPAddressField(
        ...
        migrations.AlterField(
            ...
            field=nsot.fields.BinaryIPAddressField(
                help_text="The network address for the Network. The network address and the prefix length together uniquely define a network.",
                max_length=16,
        ...
        migrations.AlterField(
            ...
            field=models.TextField(
                default="", help_text="A helpful description for the Site.", blank=True
            ),
        ),
        migrations.AlterField(
            model_name="site",
            name="name",
            field=models.CharField(
                help_text="The name of the Site.", unique=True, max_length=255
            ),
        ),
        migrations.AlterField(
            model_name="user",
            name="secret_key",
            field=models.CharField(
                default=nsot.util.core.generate_secret_key,
        ...
        migrations.AlterField(
            ...
            name="name",
            field=models.CharField(
                help_text="The name of the Attribute to which the Value is bound. (Internal use only)",
                max_length=64,
                verbose_name="Name",
                blank=True,
            ),
